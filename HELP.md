...
* The original package name 'org.tronkowski.native-demo' is invalid and this project uses 'org.tronkowski.nativedemo' instead.
...
* [Coroutines section of the Spring Framework Documentation](https://docs.spring.io/spring/docs/6.0.0-RC2/spring-framework-reference/languages.html#coroutines)
* [Spring Reactive Web](https://docs.spring.io/spring-boot/docs/3.0.0-RC1/reference/htmlsingle/#web.reactive)
* [Spring Data R2DBC](https://docs.spring.io/spring-boot/docs/3.0.0-RC1/reference/htmlsingle/#data.sql.r2dbc)
...
```
$ docker run --rm native-demo:0.0.1-SNAPSHOT
```
